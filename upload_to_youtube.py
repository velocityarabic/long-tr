...
def ensure_playlist(youtube, title="Learn Turkish Phrases for Beginners | Velocity Turkish", description="All turkish phrases videos in one playlist. 🇹🇷 Learn Turkish with Velocity Turkish!"):
